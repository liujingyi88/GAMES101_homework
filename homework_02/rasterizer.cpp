...
{   
	...
	Eigen::Vector2f side_1;
	side_1 << _v[0].x() - _v[1].x(), _v[0].y() - _v[1].y();
	Eigen::Vector2f side_2;
	side_2 << _v[1].x() - _v[2].x(), _v[1].y() - _v[2].y();
	Eigen::Vector2f side_3;
	side_3 << _v[2].x() - _v[0].x(), _v[2].y() - _v[0].y();
	...
	float z1 = side_1.x() * v1.y() - side_1.y() * v1.x();
	float z2 = side_2.x() * v2.y() - side_2.y() * v2.x();
	float z3 = side_3.x() * v3.y() - side_3.y() * v3.x();
